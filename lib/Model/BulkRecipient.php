 ...
 *
 * @category Class
 * @description Bulk notification recipient.
 * @package  EC\CNS\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BulkRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkRecipient';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['smtp_address'] === null) {
            $invalidProperties[] = "'smtp_address' can't be null";
        }
     ...
     * Sets smtp_address
     *
     * @param string $smtp_address The recipient's SMTP email address.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Optional recipient name (to be found in email To field).
     *
     * @return self
     */
