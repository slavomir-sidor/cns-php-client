...
/**
 * NotificationGroupPreferences Class Doc Comment
 *
 * @category Class
 ...
 */
class NotificationGroupPreferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationGroupPreferences';
    ...
    protected static $openAPITypes = [
        ...
        'custom_metadata' => '\EC\CNS\Client\Model\CustomMetadata[]'
    ];
    ...
    */
     ...
     *
     * @param string|null $notification_group_code Uniquely identifies a notification group.
     *
     * @return self
     */
     ...
     * Sets subscribed
     *
     * @param bool|null $subscribed If set to true, the user receives notifications. If set to false, the user does not receive notifications.
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscription_type Subscription type of the selected notification group can be one of the following INSTANT - notifications are sent immediately, DAILY_DIGEST - notifications are added to a daily notification and NO_EMAIL - no email will be sent
     *
     * @return self
     */
     ...
     *
     * @return \EC\CNS\Client\Model\CustomMetadata[]|null
     */
     ...
     *
     * @param \EC\CNS\Client\Model\CustomMetadata[]|null $custom_metadata custom_metadata
     *
     * @return self
     */
