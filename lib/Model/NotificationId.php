...
/**
 * NotificationId Class Doc Comment
 *
 * @category Class
 * @description Database identifier of the newly created notification.
 * @package  EC\CNS\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NotificationId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationId';
    ...
    */
     ...
     *
     * @param int|null $notification_id The unique notification identifier in database table.
     *
     * @return self
     */
